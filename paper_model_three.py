...
#截取一部分作为测试集
n_test_data = n_train_data[200:300]
n_train_data = n_train_data[0:200]+n_train_data[300:len(n_train_data)]
p_test_data = p_train_data[200:300]
p_train_data = p_train_data[0:200]+p_train_data[300:len(p_train_data)]
